...
if {! [file exists $base_dir/MCC150_TransmitterBPSK]} {
    file delete -force $base_dir/MCC150_TransmitterBPSK
}

project new $base_dir MCC150_TransmitterBPSK
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransmitterBPSK_fpc.do"
} else {
...
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_safe_path_msim.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_Modulator.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_PRBSGenerator.vhd
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransmitterBPSK_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            quietly set cyclenum [expr int($simtime / 4166.666667)];
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps MCC150_TransmitterBPSK_atb 
    do $base_dir/MCC150/MCC150_TransmitterBPSK_atb.wav.do
