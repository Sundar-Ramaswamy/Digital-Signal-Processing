...
if {! [file exists $base_dir/MCC150_TransmitterBPSK_x_PRBSGenerator]} {
    file delete -force $base_dir/MCC150_TransmitterBPSK_x_PRBSGenerator
}

project new $base_dir MCC150_TransmitterBPSK_x_PRBSGenerator
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransmitterBPSK_x_PRBSGenerator_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransmitterBPSK_x_PRBSGenerator_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_x_PRBSGenerator_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps MCC150_TransmitterBPSK_x_PRBSGenerator_atb 
    do $base_dir/MCC150/MCC150_TransmitterBPSK_x_PRBSGenerator_atb.wav.do
