...
entity MCC150_TransceiverBPSK_Magnitude2_atb is
end;

architecture normal of MCC150_TransceiverBPSK_Magnitude2_atb is
...
component MCC150_TransceiverBPSK_Magnitude2_stm is
    port (
...
dut : MCC150_TransceiverBPSK_Magnitude2 port map (
    in_3_dv_stm,
    in_4_dc_stm,
    in_1_I_stm,
    in_2_Q_stm,
...
sim : MCC150_TransceiverBPSK_Magnitude2_stm port map (
    in_3_dv_stm,
    in_4_dc_stm,
    in_1_I_stm,
    in_2_Q_stm,
