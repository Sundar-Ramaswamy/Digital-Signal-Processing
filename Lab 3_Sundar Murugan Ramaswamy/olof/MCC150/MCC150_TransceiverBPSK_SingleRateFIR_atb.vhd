...
entity MCC150_TransceiverBPSK_SingleRateFIR_atb is
end;

architecture normal of MCC150_TransceiverBPSK_SingleRateFIR_atb is
...
component MCC150_TransceiverBPSK_SingleRateFIR_stm is
    port (
...
dut : MCC150_TransceiverBPSK_SingleRateFIR port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_dut,
...
sim : MCC150_TransceiverBPSK_SingleRateFIR_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_stm,
