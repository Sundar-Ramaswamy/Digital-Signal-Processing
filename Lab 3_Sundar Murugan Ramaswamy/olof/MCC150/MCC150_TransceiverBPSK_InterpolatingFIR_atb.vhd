...
entity MCC150_TransceiverBPSK_InterpolatingFIR_atb is
end;

architecture normal of MCC150_TransceiverBPSK_InterpolatingFIR_atb is
...
component MCC150_TransceiverBPSK_InterpolatingFIR_stm is
    port (
...
signal xOut_0_stm : STD_LOGIC_VECTOR (26 downto 0);
...
signal xOut_0_dut : STD_LOGIC_VECTOR (26 downto 0);
...
dut : MCC150_TransceiverBPSK_InterpolatingFIR port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_dut,
...
sim : MCC150_TransceiverBPSK_InterpolatingFIR_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    xOut_v_stm,
