...
if {! [file exists $base_dir/MCC150_TransceiverBPSK_AverageMagnitude1]} {
    file delete -force $base_dir/MCC150_TransceiverBPSK_AverageMagnitude1
}

project new $base_dir MCC150_TransceiverBPSK_AverageMagnitude1
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransceiverBPSK_AverageMagnitude1_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransceiverBPSK_AverageMagnitude1_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_AverageMagnitude1_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_AvgMag} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_AvgMag $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps MCC150_TransceiverBPSK_AverageMagnitude1_atb 
    do $base_dir/MCC150/MCC150_TransceiverBPSK_AverageMagnitude1_atb.wav.do
