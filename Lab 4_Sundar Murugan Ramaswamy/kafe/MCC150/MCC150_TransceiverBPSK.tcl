# This is the top level tcl file for 'MCC150_TransceiverBPSK'
...
if {!$overwrite_opt && [project_exists MCC150_TransceiverBPSK]} {
    puts "The MCC150_TransceiverBPSK quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "../kafe/MCC150/MCC150_TransceiverBPSK.tcl"]}    {
    puts "You must run MCC150_TransceiverBPSK.tcl "
...
puts "Creating MCC150_TransceiverBPSK Quartus project..."

if $overwrite_opt {
    project_new -overwrite MCC150_TransceiverBPSK
} else {
    project_new MCC150_TransceiverBPSK
}

set_global_assignment -name FAMILY "Arria 10"
set_global_assignment -name TOP_LEVEL_ENTITY MCC150_TransceiverBPSK
set_global_assignment -name DEVICE 10AX066K2F35I1LG
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ../kafe/MCC150/MCC150_TransceiverBPSK.sdc
source ../kafe/MCC150/MCC150_TransceiverBPSK.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to I_in_x
set_instance_assignment -name VIRTUAL_PIN ON -to Q_in
set_instance_assignment -name VIRTUAL_PIN ON -to I_out
set_instance_assignment -name VIRTUAL_PIN ON -to Q_out
set_instance_assignment -name VIRTUAL_PIN ON -to Symb_I_x
set_instance_assignment -name VIRTUAL_PIN ON -to Symb_Q
set_instance_assignment -name VIRTUAL_PIN ON -to SampleIndex
set_instance_assignment -name VIRTUAL_PIN ON -to Demod_out

source "../kafe/MCC150/MCC150_TransceiverBPSK_fpc.add.tcl"
