...
if {! [file exists $base_dir/MCC150_TransmitterBPSK_x]} {
    file delete -force $base_dir/MCC150_TransmitterBPSK_x
}

project new $base_dir MCC150_TransmitterBPSK_x
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransmitterBPSK_x_fpc.do"
} else {
...
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_x_safe_path_msim.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_x.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_x_Modulator.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_x_PRBSGenerator.vhd
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransmitterBPSK_x_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_x_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps MCC150_TransmitterBPSK_x_atb 
    do $base_dir/MCC150/MCC150_TransmitterBPSK_x_atb.wav.do
