...
entity MCC150_TransceiverBPSK_Scale2_atb is
end;

architecture normal of MCC150_TransceiverBPSK_Scale2_atb is
...
component MCC150_TransceiverBPSK_Scale2_stm is
    port (
...
dut : MCC150_TransceiverBPSK_Scale2 port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : MCC150_TransceiverBPSK_Scale2_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
