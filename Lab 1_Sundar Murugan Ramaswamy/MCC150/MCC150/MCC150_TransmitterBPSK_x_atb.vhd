...
entity MCC150_TransmitterBPSK_x_atb is
end;

architecture normal of MCC150_TransmitterBPSK_x_atb is

component MCC150_TransmitterBPSK_x is
    port (
...
component MCC150_TransmitterBPSK_x_stm is
    port (
...
dut : MCC150_TransmitterBPSK_x port map (
    I_out_dut,
    Q_out_dut,
        clk,
        areset_n
...
sim : MCC150_TransmitterBPSK_x_stm port map (
    I_out_stm,
    Q_out_stm,
        clk,
        areset_n
