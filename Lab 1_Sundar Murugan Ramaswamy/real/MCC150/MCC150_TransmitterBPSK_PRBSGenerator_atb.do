...
if {! [file exists $base_dir/MCC150_TransmitterBPSK_PRBSGenerator]} {
    file delete -force $base_dir/MCC150_TransmitterBPSK_PRBSGenerator
}

project new $base_dir MCC150_TransmitterBPSK_PRBSGenerator
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransmitterBPSK_PRBSGenerator_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransmitterBPSK_PRBSGenerator_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransmitterBPSK_PRBSGenerator_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_3_PRBS} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_PRBS $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps MCC150_TransmitterBPSK_PRBSGenerator_atb 
    do $base_dir/MCC150/MCC150_TransmitterBPSK_PRBSGenerator_atb.wav.do
