...
if {! [file exists $base_dir/MCC150_TransceiverBPSK_IndexUpdate]} {
    file delete -force $base_dir/MCC150_TransceiverBPSK_IndexUpdate
}

project new $base_dir MCC150_TransceiverBPSK_IndexUpdate
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransceiverBPSK_IndexUpdate_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransceiverBPSK_IndexUpdate_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_IndexUpdate_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_SampleIndex} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_SampleIndex $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps MCC150_TransceiverBPSK_IndexUpdate_atb 
    do $base_dir/MCC150/MCC150_TransceiverBPSK_IndexUpdate_atb.wav.do
