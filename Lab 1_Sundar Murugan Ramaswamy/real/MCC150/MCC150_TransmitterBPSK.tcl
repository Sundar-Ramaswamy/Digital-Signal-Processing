# This is the top level tcl file for 'MCC150_TransmitterBPSK'
...
if {!$overwrite_opt && [project_exists MCC150_TransmitterBPSK]} {
    puts "The MCC150_TransmitterBPSK quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "../real/MCC150/MCC150_TransmitterBPSK.tcl"]}    {
    puts "You must run MCC150_TransmitterBPSK.tcl "
...
puts "Creating MCC150_TransmitterBPSK Quartus project..."

if $overwrite_opt {
    project_new -overwrite MCC150_TransmitterBPSK
} else {
    project_new MCC150_TransmitterBPSK
}

set_global_assignment -name FAMILY "Arria 10"
set_global_assignment -name TOP_LEVEL_ENTITY MCC150_TransmitterBPSK
set_global_assignment -name DEVICE 10AX066K2F35I1LG
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ../real/MCC150/MCC150_TransmitterBPSK.sdc
source ../real/MCC150/MCC150_TransmitterBPSK.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to I_out
set_instance_assignment -name VIRTUAL_PIN ON -to Q_out

source "../real/MCC150/MCC150_TransmitterBPSK_fpc.add.tcl"
