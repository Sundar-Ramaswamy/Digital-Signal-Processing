...
-- VHDL created from MCC150_TransceiverBPSK_Magnitude1
...
entity MCC150_TransceiverBPSK_Magnitude1_atb is
end;

architecture normal of MCC150_TransceiverBPSK_Magnitude1_atb is
...
component MCC150_TransceiverBPSK_Magnitude1_stm is
    port (
...
signal in_1_I_stm : STD_LOGIC_VECTOR (11 downto 0);
signal in_2_Q_stm : STD_LOGIC_VECTOR (11 downto 0);
signal out_1_qv_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_Mag_stm : STD_LOGIC_VECTOR (11 downto 0);
signal in_3_dv_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_4_dc_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_1_I_dut : STD_LOGIC_VECTOR (11 downto 0);
signal in_2_Q_dut : STD_LOGIC_VECTOR (11 downto 0);
signal out_1_qv_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_Mag_dut : STD_LOGIC_VECTOR (11 downto 0);
...
checkChannelIn : process (clk, areset_n, in_1_I_dut, in_1_I_stm, in_2_Q_dut, in_2_Q_stm)
begin
END PROCESS;


-- Channelized data out check
checkChannelOut : process (clk, areset_n, out_3_Mag_dut, out_3_Mag_stm)
variable mismatch_out_1_qv : BOOLEAN := FALSE;
variable mismatch_out_2_qc : BOOLEAN := FALSE;
variable mismatch_out_3_Mag : BOOLEAN := FALSE;
...
begin
    ...
    ELSIF (clk'EVENT AND clk = '0') THEN -- falling clock edge to avoid transitions
        ...
        IF (out_1_qv_dut = "1") THEN
            ...
            END IF;
            IF ( (out_3_Mag_dut /= out_3_Mag_stm)) THEN
                mismatch_out_3_Mag := TRUE;
                report "mismatch in out_3_Mag signal" severity Warning;
            END IF;
        END IF;
        IF (mismatch_out_1_qv = TRUE or mismatch_out_2_qc = TRUE or mismatch_out_3_Mag = TRUE) THEN
            ok := FALSE;
        END IF;
        IF (ok = FALSE) THEN
...
dut : MCC150_TransceiverBPSK_Magnitude1 port map (
    in_3_dv_stm,
    in_4_dc_stm,
    in_1_I_stm,
    in_2_Q_stm,
...
sim : MCC150_TransceiverBPSK_Magnitude1_stm port map (
    in_3_dv_stm,
    in_4_dc_stm,
    in_1_I_stm,
    in_2_Q_stm,
