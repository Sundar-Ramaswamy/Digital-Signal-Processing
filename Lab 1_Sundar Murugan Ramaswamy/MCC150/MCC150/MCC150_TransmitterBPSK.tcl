...
} elseif {![file exists "./rtl/MCC150/MCC150_TransmitterBPSK.tcl"]}    {
...
set_global_assignment -name SDC_FILE ./rtl/MCC150/MCC150_TransmitterBPSK.sdc
source ./rtl/MCC150/MCC150_TransmitterBPSK.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to I_out
set_instance_assignment -name VIRTUAL_PIN ON -to Q_out

source "./rtl/MCC150/MCC150_TransmitterBPSK_fpc.add.tcl"
