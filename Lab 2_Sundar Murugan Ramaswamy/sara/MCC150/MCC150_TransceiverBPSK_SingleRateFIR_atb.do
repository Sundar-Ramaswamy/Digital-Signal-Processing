...
if {! [file exists $base_dir/MCC150_TransceiverBPSK_SingleRateFIR]} {
    file delete -force $base_dir/MCC150_TransceiverBPSK_SingleRateFIR
}

project new $base_dir MCC150_TransceiverBPSK_SingleRateFIR
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransceiverBPSK_SingleRateFIR_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransceiverBPSK_SingleRateFIR_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_SingleRateFIR_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps MCC150_TransceiverBPSK_SingleRateFIR_atb 
    do $base_dir/MCC150/MCC150_TransceiverBPSK_SingleRateFIR_atb.wav.do
