...
entity MCC150_TransmitterBPSK_PRBSGenerator_atb is
end;

architecture normal of MCC150_TransmitterBPSK_PRBSGenerator_atb is

component MCC150_TransmitterBPSK_PRBSGenerator is
    port (
...
component MCC150_TransmitterBPSK_PRBSGenerator_stm is
    port (
...
checkChannelOut : process (clk, areset, out_3_PRBS_dut, out_3_PRBS_stm)
...
dut : MCC150_TransmitterBPSK_PRBSGenerator port map (
    out_1_qv_dut,
    out_2_qc_dut,
    out_3_PRBS_dut,
        clk,
...
sim : MCC150_TransmitterBPSK_PRBSGenerator_stm port map (
    out_1_qv_stm,
    out_2_qc_stm,
    out_3_PRBS_stm,
        clk,
