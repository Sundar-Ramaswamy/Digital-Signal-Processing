...
entity MCC150_TransceiverBPSK_Scale_atb is
end;

architecture normal of MCC150_TransceiverBPSK_Scale_atb is
...
component MCC150_TransceiverBPSK_Scale_stm is
    port (
...
signal xIn_0_stm : STD_LOGIC_VECTOR (26 downto 0);
...
signal xIn_0_dut : STD_LOGIC_VECTOR (26 downto 0);
...
dut : MCC150_TransceiverBPSK_Scale port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
...
sim : MCC150_TransceiverBPSK_Scale_stm port map (
    xIn_v_stm,
    xIn_c_stm,
    xIn_0_stm,
    gain_i_stm,
