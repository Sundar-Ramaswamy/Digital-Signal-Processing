...
if {! [file exists $base_dir/MCC150_TransceiverBPSK]} {
    file delete -force $base_dir/MCC150_TransceiverBPSK
}

project new $base_dir MCC150_TransceiverBPSK
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/MCC150/MCC150_TransceiverBPSK_fpc.do"
} else {
...
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_safe_path_msim.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_AverageMagnitude1.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_AverageMagnitude3.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_CPR.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Decimation.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Demodulator.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_IndexUpdate.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_InterpolatingFIR.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Magnitude1.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Magnitude2.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Modulator.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_PRBSGenerator.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Scale.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Scale1.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_Scale2.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_SingleRateFIR.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_SingleRateFIR1.vhd
vcom -quiet -O0 $base_dir/MCC150/MCC150_TransceiverBPSK_atb.vhd
vcom -quiet $base_dir/MCC150/MCC150_TransceiverBPSK_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_I_out} mismatch] == 0 && $mismatch } {
                report_mismatch I_out $cyclenum
            }
            if { [catch {exa mismatch_Q_out} mismatch] == 0 && $mismatch } {
                report_mismatch Q_out $cyclenum
            }
            if { [catch {exa mismatch_Symb_I_x} mismatch] == 0 && $mismatch } {
                report_mismatch Symb_I_x $cyclenum
            }
            if { [catch {exa mismatch_Symb_Q} mismatch] == 0 && $mismatch } {
                report_mismatch Symb_Q $cyclenum
            }
            if { [catch {exa mismatch_SampleIndex} mismatch] == 0 && $mismatch } {
                report_mismatch SampleIndex $cyclenum
            }
            if { [catch {exa mismatch_Demod_out} mismatch] == 0 && $mismatch } {
                report_mismatch Demod_out $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps MCC150_TransceiverBPSK_atb 
    do $base_dir/MCC150/MCC150_TransceiverBPSK_atb.wav.do
