# This is the top level tcl file for 'MCC150_TransmitterBPSK_x'
...
if {!$overwrite_opt && [project_exists MCC150_TransmitterBPSK_x]} {
    puts "The MCC150_TransmitterBPSK_x quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "./rtl/MCC150/MCC150_TransmitterBPSK_x.tcl"]}    {
    puts "You must run MCC150_TransmitterBPSK_x.tcl "
...
puts "Creating MCC150_TransmitterBPSK_x Quartus project..."

if $overwrite_opt {
    project_new -overwrite MCC150_TransmitterBPSK_x
} else {
    project_new MCC150_TransmitterBPSK_x
}

set_global_assignment -name FAMILY "Cyclone V"
set_global_assignment -name TOP_LEVEL_ENTITY MCC150_TransmitterBPSK_x
set_global_assignment -name DEVICE 5CSXFC6D6F31C6
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ./rtl/MCC150/MCC150_TransmitterBPSK_x.sdc
source ./rtl/MCC150/MCC150_TransmitterBPSK_x.add.tcl

set_instance_assignment -name VIRTUAL_PIN ON -to I_out
set_instance_assignment -name VIRTUAL_PIN ON -to Q_out

source "./rtl/MCC150/MCC150_TransmitterBPSK_x_fpc.add.tcl"
