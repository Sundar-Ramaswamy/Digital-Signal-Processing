...
entity MCC150_TransmitterBPSK_Modulator_atb is
end;

architecture normal of MCC150_TransmitterBPSK_Modulator_atb is

component MCC150_TransmitterBPSK_Modulator is
    port (
...
component MCC150_TransmitterBPSK_Modulator_stm is
    port (
...
checkChannelIn : process (clk, areset, in_3_Data_dut, in_3_Data_stm)
begin
END PROCESS;


-- Channelized data out check
checkChannelOut : process (clk, areset, out_3_I_dut, out_3_I_stm)
...
dut : MCC150_TransmitterBPSK_Modulator port map (
    in_1_dv_x_stm,
    in_2_dc_stm,
    in_3_Data_stm,
    out_1_qv_dut,
...
sim : MCC150_TransmitterBPSK_Modulator_stm port map (
    in_1_dv_x_stm,
    in_2_dc_stm,
    in_3_Data_stm,
    out_1_qv_stm,
