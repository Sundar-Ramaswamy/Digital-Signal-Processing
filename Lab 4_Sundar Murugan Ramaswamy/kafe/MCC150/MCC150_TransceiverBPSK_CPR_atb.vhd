...
entity MCC150_TransceiverBPSK_CPR_atb is
end;

architecture normal of MCC150_TransceiverBPSK_CPR_atb is
...
component MCC150_TransceiverBPSK_CPR_stm is
    port (
...
signal out_1_I_Out_stm : STD_LOGIC_VECTOR (13 downto 0);
...
signal out_1_I_Out_dut : STD_LOGIC_VECTOR (13 downto 0);
...
dut : MCC150_TransceiverBPSK_CPR port map (
    in_3_dv_stm,
    in_4_dc_stm,
    in_1_I_in_stm,
    in_2_Q_in_stm,
...
sim : MCC150_TransceiverBPSK_CPR_stm port map (
    in_3_dv_stm,
    in_4_dc_stm,
    in_1_I_in_stm,
    in_2_Q_in_stm,
